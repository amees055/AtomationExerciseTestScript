...
public class TC_15_PlaceOrderRegisterBeforeCheckout extends BaseClass {
	@Test
	public void registerbeforececkout() throws IOException, InterruptedException {
		driver.get(baseURl);
log.info("URL is Opened");
		...
		{
			captureScreen(driver, "registerbeforececkout");
			Assert.assertTrue(false);
		} 

		driver.findElement(By.xpath("//*[@id=\"header\"]/div/div/div/div[2]/div/ul/li[4]/a")).click();
		String expectedText = "New User Signup!";
        By elementLocator = By.xpath("//*[@id=\"form\"]/div/div/div[3]/div/h2"); 
